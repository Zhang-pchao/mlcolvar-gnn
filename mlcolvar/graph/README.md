...
- [`toy_dataset.py`](examples/toy_dataset.py) builds a synthetic
  ...
  saving the graphs to disk for reuse.【F:mlcolvar/graph/examples/toy_dataset.py†L1-L120】
- [`train_deeptda.py`](examples/train_deeptda.py) fits a
  ...
  checkpoint.【F:mlcolvar/graph/examples/train_deeptda.py†L1-L86】
- [`analyze_sensitivity.py`](examples/analyze_sensitivity.py) reloads the
  ...
  which atoms drive the learned CV.【F:mlcolvar/graph/examples/analyze_sensitivity.py†L1-L78】
